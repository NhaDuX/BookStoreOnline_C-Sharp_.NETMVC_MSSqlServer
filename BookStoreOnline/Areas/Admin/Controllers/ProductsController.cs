...
namespace BookStoreOnline.Areas.Admin.Controllers
{
    public class ProductController : Controller
    {
        ...
        {
            var Product = (from p in db.Product orderby p.ProductID descending select p).ToList();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductID,ProductName,Price,Introduce,ImageProd,CategoryID")] Product product, HttpPostedFileBase imageBook)
        {
            if (ModelState.IsValid)
            {
                if (imageBook != null)
